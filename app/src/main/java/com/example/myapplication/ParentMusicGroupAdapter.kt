...
import com.example.myapplication.databinding.ItemParentMusicGroupBinding
...
class ParentMusicGroupAdapter: ListAdapter<MusicGroup, RecyclerView.ViewHolder>(MusicGroupDiffCallback()) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        with(holder as ViewHolder){
            binding.tvParent.text = musicGroup.name
            val childAdapter = ChildSongAdapter()
            childAdapter.submitList(musicGroup.song.shuffled())
